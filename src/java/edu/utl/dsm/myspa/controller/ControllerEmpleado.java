 ...
 * consulta de informacion de los empleados en la base de datos.
 *
 * @author LiveGrios
 */
public class ControllerEmpleado {
	 ...
	 *
	 * @param e Es el objeto de tipo {@link Empleado}, el cual contiene los
	...
	/**
	 * Actualiza un registro de {@link Empleado}, previamente existente, en la
	 * base de datos.
	 *
	 * @param e Es el objeto de tipo {@link Empleado}, el cual contiene los
	 * datos que seran insertados dentro del nuevo registro.
	 ...
	 * @return Devuelve el {@link Empleado} que se encuentra en la base de
	 * datos, basado en la coincidencia filter pasado como parámetro. Si no es
	 * encontrado un {@link Empleado} , el método devolvera <code>null</code>.
	 * @throws Exception
	 */
	 ...
	 * @return Devuelve el listado de empleados encontrados en la base de datos,
	 * en forma de una lista dinamica <code>List&lt;{@link Empleado}&rt;</code>.
	 * Si la base de datos no tiene algun registro de empleado, se devuelve una
